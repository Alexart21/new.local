...
$this->title = 'Офисная мебель на заказ в Чебоксарах' . $pageNum;
...
?>
<h1 class="header_shadow text-center" >Офисная мебель в Чебоксарах от <i><?= Yii::$app->params['company'] ?></i></h1>
