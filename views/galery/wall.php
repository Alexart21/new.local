...
$this->title = 'Стенки на заказ в Чебоксарах'.Yii::$app->params['company'] . $pageNum;
...
?>
<h1 class="header_shadow text-center" >Стенки на заказ в Чебоксарах от <i><?= Yii::$app->params['company'] ?></i></h1>
