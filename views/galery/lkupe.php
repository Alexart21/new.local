...
$this->title = 'Шкафы купе на заказ в Чебоксарах'.Yii::$app->params['company'] . $pageNum;
...
?>
<h1 class="header_shadow text-center" >Шкафы купе на заказ в Чебоксарах от <i><?= Yii::$app->params['company'] ?></i></h1>
